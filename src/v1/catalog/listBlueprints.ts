...
import { ListBlueprintsResponse } from "../schemas";

export { ListBlueprintsResponse };
export type ListBlueprintsResponseType = Schema.Schema.Type<
  typeof ListBlueprintsResponse
>;

/**
 * Retrieve a list of all available blueprints
 *
 * @returns Effect that yields the list of blueprints
 *
 * @example
 * const blueprints = printify.catalog.listBlueprints();
 * // Expected response: [
 * //   {
 * //     id: 3,
...
const listBlueprints = () =>
  requestPrintify(ListBlueprintsResponse, "/v1/catalog/blueprints.json", {
    method: "GET",
  });
