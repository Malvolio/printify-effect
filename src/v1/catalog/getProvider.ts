...
import { GetProviderResponse } from "../schemas";

export { GetProviderResponse };
export type GetProviderResponseType = Schema.Schema.Type<
  typeof GetProviderResponse
>;
 ...
 * @returns Effect that yields the provider details
 *
 * @example
 * const printProviderId = "123456";
 * const provider = printify.catalog.getProvider(printProviderId);
 * // Expected response: {
 *   "id": 1,
 ...
 * }
 */
const getProvider = (printProviderId: string) =>
  requestPrintify(
    GetProviderResponse,
